        ...
        <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="/img/gedung-smkn2.jpeg" class="d-block w-100 img-fluid landscape" alt="Gedung SMKN2">
                </div>
                <div class="carousel-item active">
                    <img src="/img/gedung-smkn2.jpeg" class="d-block w-100 img-fluid landscape" alt="Gedung SMKN2">
                </div>
        ...
        <div class="container">
            ...
            <div class="row stravisco-kepsek-photo justify-content-center">
                <div class="col-lg-4" data-aos="fade-up" data-aos-duration="1000">
                    <img src="/img/B.AGUS_WIMBADI__M.Pd.png" class="img-fluid potrait" data-name="B. Agus Wimbadi M.Pd"
                        data-position="Kepala Sekolah SMKN 2 Kota Bekasi" alt="Kepala Sekolah">
            ...
            <div class="row justify-content-center about-text">
                <div class="col-lg-12" data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <p>
                        SMK Negeri 2 Kota Bekasi didirikan pada tahun 2004, berdasarkan surat keputusan Wali kota Bekasi
                        nomor
            ...
            <div class="row justify-center-center about-text">
                <div class="col-lg-12" data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <p data-aos="fade-up" data-aos-duration="1000">
                        SMK Negeri 2 Kota Bekasi adalah salah satu sekolah menengah kejuruan yang berada di Kota Bekasi,
                        Jawa
                        Barat. <br>
                    </p>
                    <p data-aos="fade-up" data-aos-duration="1000">
                        Sekolah ini terletak di Kelurahan Ciketing Udik, Kecamatan Bantar Gebang, Kota Bekasi. Sekolah ini
                        pun
                        hanya berjarak 200 meter dari TPST Bantar Gebang, tetapi uniknya tidak tercium bau sampah di
                        lingkungan
                        sekolah ini. Sekolah ini menjadi sekolah negeri terluas di Kota Bekasi dengan luas tanah mencapai
                        15.540
                    ...
                    <p data-aos="fade-up" data-aos-duration="1000">
                        SMK Negeri 2 Kota Bekasi mempunyai komitmen untuk selalu menjaga dan melestarikan lingkungan hidup
                        di
                        lingkungan sekolah dan lingkungan sekitar. Sekolah ini pernah mendapat penghargaan Adiwiyata Mandiri
                        dari Kementrian Lingkungan Hidup pada tahun 2012. <br> <br>
                    </p>
                    <p data-aos="fade-up" data-aos-duration="1000">
